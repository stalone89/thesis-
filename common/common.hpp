...
/** @brief  */
enum class REDUNDANT_VEHICLE_STATUS_FLAGS : uint16_t
{
...
//! REDUNDANT_VEHICLE_STATUS_FLAGS ENUM_END
constexpr auto REDUNDANT_VEHICLE_STATUS_FLAGS_ENUM_END = 2049;

/** @brief  */
enum class REDUNDANT_VEHICLE_STATUS_FAILUREDETECTOR : uint8_t
{
    FAILURE_NONE=1, /*  | */
    FAILURE_ROLL=2, /*  | */
    FAILURE_PITCH=4, /*  | */
...
//! REDUNDANT_VEHICLE_STATUS_FAILUREDETECTOR ENUM_END
constexpr auto REDUNDANT_VEHICLE_STATUS_FAILUREDETECTOR_ENUM_END = 33;

/** @brief  */
enum class REDUNDANT_VEHICLE_STATUS_MAIN : uint8_t
{
    FAILSAFE=1, /*  | */
    DATA_LINK_LOST=2, /*  | */
    ENGINE_FAILURE=4, /*  | */
...
//! REDUNDANT_VEHICLE_STATUS_MAIN ENUM_END
constexpr auto REDUNDANT_VEHICLE_STATUS_MAIN_ENUM_END = 9;

/** @brief  */
enum class REDUNDANT_PILOT_SELECTED : uint8_t
{
    PILOT_1_SELECTED=0, /*  | */
    PILOT_2_SELECTED=1, /*  | */
    PILOT_3_SELECTED=2, /*  | */
...
//! REDUNDANT_PILOT_SELECTED ENUM_END
constexpr auto REDUNDANT_PILOT_SELECTED_ENUM_END = 3;
...
#include "./mavlink_msg_redundant_vehicle_status.hpp"
#include "./mavlink_msg_redundant_vehicle_selected.hpp"
