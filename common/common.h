...
/** @brief  */
#ifndef HAVE_ENUM_REDUNDANT_VEHICLE_STATUS_FLAGS
#define HAVE_ENUM_REDUNDANT_VEHICLE_STATUS_FLAGS
typedef enum REDUNDANT_VEHICLE_STATUS_FLAGS
{
   CONDITION_SYSTEM_SENSORS_INITIALIZED=1, /*  | */
   CONDITION_ANGULAR_VELOCITY_VALID=2, /*  | */
   CONDITION_ATTITUDE_VALID=4, /*  | */
   CONDITION_LOCAL_ALTITUDE_VALID=8, /*  | */
   CONDITION_LOCAL_POSITION_VALID=16, /*  | */
   CONDITION_lOCAL_VELOCITY_VALID=32, /*  | */
   CONDITION_HOME_POSITION_VALID=64, /*  | */
   CONDITION_POWER_INPUT_VALID=128, /*  | */
   CONDITION_BATTERY_HEALTHY_VALID=256, /*  | */
   CONDITION_ESCS_ERROR=512, /*  | */
   CONDITION_ESCS_FAILURE=1024, /*  | */
   CONDITION_GLOBAL_POSITION_VALID=2048, /*  | */
   REDUNDANT_VEHICLE_STATUS_FLAGS_ENUM_END=2049, /*  | */
} REDUNDANT_VEHICLE_STATUS_FLAGS;
#endif

/** @brief  */
#ifndef HAVE_ENUM_REDUNDANT_VEHICLE_STATUS_FAILUREDETECTOR
#define HAVE_ENUM_REDUNDANT_VEHICLE_STATUS_FAILUREDETECTOR
typedef enum REDUNDANT_VEHICLE_STATUS_FAILUREDETECTOR
{
   FAILURE_NONE=1, /*  | */
   FAILURE_ROLL=2, /*  | */
   FAILURE_PITCH=4, /*  | */
   ...
   FAILURE_EXT=16, /*  | */
   FAILURE_ARM_ESCS=32, /*  | */
   REDUNDANT_VEHICLE_STATUS_FAILUREDETECTOR_ENUM_END=33, /*  | */
} REDUNDANT_VEHICLE_STATUS_FAILUREDETECTOR;
#endif

/** @brief  */
#ifndef HAVE_ENUM_REDUNDANT_VEHICLE_STATUS_MAIN
#define HAVE_ENUM_REDUNDANT_VEHICLE_STATUS_MAIN
typedef enum REDUNDANT_VEHICLE_STATUS_MAIN
{
   FAILSAFE=1, /*  | */
   DATA_LINK_LOST=2, /*  | */
   ENGINE_FAILURE=4, /*  | */
   MISSION_FAILURE=8, /*  | */
   REDUNDANT_VEHICLE_STATUS_MAIN_ENUM_END=9, /*  | */
} REDUNDANT_VEHICLE_STATUS_MAIN;
#endif

/** @brief  */
#ifndef HAVE_ENUM_REDUNDANT_PILOT_SELECTED
#define HAVE_ENUM_REDUNDANT_PILOT_SELECTED
typedef enum REDUNDANT_PILOT_SELECTED
{
   PILOT_1_SELECTED=0, /*  | */
   PILOT_2_SELECTED=1, /*  | */
   PILOT_3_SELECTED=2, /*  | */
   REDUNDANT_PILOT_SELECTED_ENUM_END=3, /*  | */
} REDUNDANT_PILOT_SELECTED;
#endif
...
#include "./mavlink_msg_redundant_vehicle_status.h"
#include "./mavlink_msg_redundant_vehicle_selected.h"
