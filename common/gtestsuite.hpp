...
TEST(common, REDUNDANT_VEHICLE_STATUS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::REDUNDANT_VEHICLE_STATUS packet_in{};
    packet_in.target_system = 211;
    packet_in.target_component = 22;
    packet_in.time_usec = 93372036854775807ULL;
    packet_in.takeoff_time = 93372036854776311ULL;
    packet_in.failsafe_timestamp = 93372036854776815ULL;
    packet_in.data_link_lost_counter = 89;
    packet_in.redundant_vehicle_status_flags = 18483;
    packet_in.redundant_vehicle_status_failuredetector = 156;
    packet_in.redundant_vehicle_status_main = 223;

    mavlink::common::msg::REDUNDANT_VEHICLE_STATUS packet1{};
    mavlink::common::msg::REDUNDANT_VEHICLE_STATUS packet2{};
    ...
    EXPECT_EQ(packet1.target_component, packet2.target_component);
    EXPECT_EQ(packet1.time_usec, packet2.time_usec);
    EXPECT_EQ(packet1.takeoff_time, packet2.takeoff_time);
    EXPECT_EQ(packet1.failsafe_timestamp, packet2.failsafe_timestamp);
    EXPECT_EQ(packet1.data_link_lost_counter, packet2.data_link_lost_counter);
    EXPECT_EQ(packet1.redundant_vehicle_status_flags, packet2.redundant_vehicle_status_flags);
    EXPECT_EQ(packet1.redundant_vehicle_status_failuredetector, packet2.redundant_vehicle_status_failuredetector);
    EXPECT_EQ(packet1.redundant_vehicle_status_main, packet2.redundant_vehicle_status_main);
}

#ifdef TEST_INTEROP
TEST(common_interop, REDUNDANT_VEHICLE_STATUS)
{
    mavlink_message_t msg;
    ...
    mavlink_redundant_vehicle_status_t packet_c {
    ...
    mavlink_msg_redundant_vehicle_status_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.target_component, packet2.target_component);
    EXPECT_EQ(packet_in.time_usec, packet2.time_usec);
    EXPECT_EQ(packet_in.takeoff_time, packet2.takeoff_time);
    EXPECT_EQ(packet_in.failsafe_timestamp, packet2.failsafe_timestamp);
    EXPECT_EQ(packet_in.data_link_lost_counter, packet2.data_link_lost_counter);
    EXPECT_EQ(packet_in.redundant_vehicle_status_flags, packet2.redundant_vehicle_status_flags);
    EXPECT_EQ(packet_in.redundant_vehicle_status_failuredetector, packet2.redundant_vehicle_status_failuredetector);
    EXPECT_EQ(packet_in.redundant_vehicle_status_main, packet2.redundant_vehicle_status_main);
...
TEST(common, REDUNDANT_VEHICLE_SELECTED)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::REDUNDANT_VEHICLE_SELECTED packet_in{};
    packet_in.target_system = 29;
    packet_in.target_component = 96;
    packet_in.time_usec = 93372036854775807ULL;
    packet_in.redundant_px4_selected = 163;

    mavlink::common::msg::REDUNDANT_VEHICLE_SELECTED packet1{};
    mavlink::common::msg::REDUNDANT_VEHICLE_SELECTED packet2{};
    ...
    EXPECT_EQ(packet1.target_component, packet2.target_component);
    EXPECT_EQ(packet1.time_usec, packet2.time_usec);
    EXPECT_EQ(packet1.redundant_px4_selected, packet2.redundant_px4_selected);
}

#ifdef TEST_INTEROP
TEST(common_interop, REDUNDANT_VEHICLE_SELECTED)
{
    mavlink_message_t msg;
    ...
    mavlink_redundant_vehicle_selected_t packet_c {
    ...
    mavlink_msg_redundant_vehicle_selected_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.target_component, packet2.target_component);
    EXPECT_EQ(packet_in.time_usec, packet2.time_usec);
    EXPECT_EQ(packet_in.redundant_px4_selected, packet2.redundant_px4_selected);
