...
static void mavlink_test_redundant_vehicle_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_REDUNDANT_VEHICLE_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_redundant_vehicle_status_t packet_in = {
        93372036854775807ULL,93372036854776311ULL,93372036854776815ULL,18483,211,22,89,156,223
    };
    mavlink_redundant_vehicle_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.takeoff_time = packet_in.takeoff_time;
        packet1.failsafe_timestamp = packet_in.failsafe_timestamp;
        packet1.redundant_vehicle_status_flags = packet_in.redundant_vehicle_status_flags;
        packet1.target_system = packet_in.target_system;
        packet1.target_component = packet_in.target_component;
        packet1.data_link_lost_counter = packet_in.data_link_lost_counter;
        packet1.redundant_vehicle_status_failuredetector = packet_in.redundant_vehicle_status_failuredetector;
        packet1.redundant_vehicle_status_main = packet_in.redundant_vehicle_status_main;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_REDUNDANT_VEHICLE_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_REDUNDANT_VEHICLE_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_redundant_vehicle_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_redundant_vehicle_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_redundant_vehicle_status_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.time_usec , packet1.takeoff_time , packet1.failsafe_timestamp , packet1.data_link_lost_counter , packet1.redundant_vehicle_status_flags , packet1.redundant_vehicle_status_failuredetector , packet1.redundant_vehicle_status_main );
    mavlink_msg_redundant_vehicle_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_redundant_vehicle_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.time_usec , packet1.takeoff_time , packet1.failsafe_timestamp , packet1.data_link_lost_counter , packet1.redundant_vehicle_status_flags , packet1.redundant_vehicle_status_failuredetector , packet1.redundant_vehicle_status_main );
    mavlink_msg_redundant_vehicle_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_redundant_vehicle_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_redundant_vehicle_status_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.time_usec , packet1.takeoff_time , packet1.failsafe_timestamp , packet1.data_link_lost_counter , packet1.redundant_vehicle_status_flags , packet1.redundant_vehicle_status_failuredetector , packet1.redundant_vehicle_status_main );
    mavlink_msg_redundant_vehicle_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_redundant_vehicle_selected(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_REDUNDANT_VEHICLE_SELECTED >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_redundant_vehicle_selected_t packet_in = {
        93372036854775807ULL,29,96,163
    };
    mavlink_redundant_vehicle_selected_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.target_system = packet_in.target_system;
        packet1.target_component = packet_in.target_component;
        packet1.redundant_px4_selected = packet_in.redundant_px4_selected;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_REDUNDANT_VEHICLE_SELECTED_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_REDUNDANT_VEHICLE_SELECTED_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_redundant_vehicle_selected_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_redundant_vehicle_selected_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_redundant_vehicle_selected_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.time_usec , packet1.redundant_px4_selected );
    mavlink_msg_redundant_vehicle_selected_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_redundant_vehicle_selected_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.time_usec , packet1.redundant_px4_selected );
    mavlink_msg_redundant_vehicle_selected_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_redundant_vehicle_selected_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_redundant_vehicle_selected_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.time_usec , packet1.redundant_px4_selected );
    mavlink_msg_redundant_vehicle_selected_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_redundant_vehicle_status(system_id, component_id, last_msg);
    mavlink_test_redundant_vehicle_selected(system_id, component_id, last_msg);
